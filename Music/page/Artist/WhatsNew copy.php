...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        echo '
        <div>
            <a class="song-container" href="../Playlist/index.php?id=' . $row['album_id'] . '">
                <div class="header-side-area">
                    <div class="header-side-area-flex-container">
                        <div class="album-art-container">
                            <div class="album-art" style="width: 112px; height: 112px">
                                <img src="' . $row['image_url'] . '" data-testid="entity-image" alt="Midnight Blues" class="album-art-image" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="header-area">
                    ...
                    <div class="interactive-area bottom-area">
