...
<body>
                       ...
                       <a href="./page/Playlist/index.php?id=' . $row['id'] . '" class="items">
                         ...
                         <div class="items-text">
                           ...
                           <div class="items-artist">
                            ...
                            echo '<li >Login to add playlist</li>';
                        }
                            ?>
        ...
        <main>
            ...
            <div class="frame" id="frame">
                <div class="div" id="div">
                    <?php
                    $sql = "SELECT `id`, `title`, `genre`, `playlist_id`, `release_date`, `popularity`, `image_url` FROM `album` WHERE `id` = '1'";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
    ...
    <div class="div-2">
    <div class="text-wrapper-2">' . $playlist['title'] . '</div>
    <div class="text-wrapper">' . $playlist['genre'] . '</div>
